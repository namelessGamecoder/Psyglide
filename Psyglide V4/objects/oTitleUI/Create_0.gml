...
closeUI = function(){uiTransition(oQuitGameUI,TRANSITION_TYPE.WIPEU,6);sfxPlay(sfxCancel);};
...
buttonSelect[1][2] = newButtonSprite(RES_W/2 + 160, RES_H/2 + 48,sExitGameButton,closeUI);
