buttonSelect[0][0] = newButtonSprite(RES_W/2 - 160,RES_H/2 - 48,sNewGameButton,function(){roomTransition(rmW1Lvl1,TRANSITION_TYPE.FADE,4);screenShake(20,0.25);sfxPlay(sfxConfirm);bgmPlay(bgmGildedRuins);});
