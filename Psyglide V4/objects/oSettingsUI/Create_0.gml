...
buttonSelect[3][0] = newButtonSprite(RES_W - 64,RES_H - 32,sBackButton,function(){if (room != rmTitle){uiTransition(oPauseUI,TRANSITION_TYPE.WIPER,4);}else{uiTransition(oTitleUI,TRANSITION_TYPE.WIPER,4);}settingsLeave = true;sfxPlay(sfxCancel);});
