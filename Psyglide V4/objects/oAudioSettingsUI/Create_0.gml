...
buttonSelect[0][3] = newHoldButtonSprite(RES_W/2 - 144,RES_H/2 - 32,sLeftArrowButton,function() {global.masterVolume -= 0.01; global.masterVolume = max(0,global.masterVolume);});
buttonSelect[0][2] = newHoldButtonSprite(RES_W/2 - 144,RES_H/2 + 24,sLeftArrowButton,function() {global.musicVolume -= 0.01; global.musicVolume = max(0,global.musicVolume);});
buttonSelect[0][1] = newHoldButtonSprite(RES_W/2 - 144,RES_H/2 + 80,sLeftArrowButton,function() {global.sfxVolume -= 0.01; global.sfxVolume = max(0,global.sfxVolume);});
